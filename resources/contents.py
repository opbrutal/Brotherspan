...
RAID = [
    ...
    "TERI MAA CHUD GYI NON STOP BY BROTHERS OP",
    "TERI BHEN KE BHOSDE ME BROTHERS KA LODA",
    "TERI MAA KI CHUT ME DUNGA MOOT KHADE KHADE",
    "BROTHERS NE CHOD DALA KHANDAN OHHO",
]
